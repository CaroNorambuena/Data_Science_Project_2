# Data_Science_Project_2: Aplicación algoritmo Random Forest y KNN para un caso propuesto
...
Para realizar este proyecto, se utilizaron dos base de datos, las cuales se unificaron en una base de datos:
- Featuresdataset.csv
- salesdata-set.csv
